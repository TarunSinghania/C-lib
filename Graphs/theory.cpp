...
"Simple cycle" or "simple circuit" is a geometric term which mean that this cycle is not formed by multiple smaller cycles. It has been studied for many years and there were a lot of algorithms being invented.

We will use a simplified formula to count the simple cycles:

In one undirected graph,

Number of simple cycles = Edges - Vertices + 1
