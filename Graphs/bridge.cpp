...
////idea for directed : not tested : 
//if for each dfs tree we can calclate brides normally
//for each edge that connects two different dfs tree
//that edge is always a bridge as well 
//(not tested)
