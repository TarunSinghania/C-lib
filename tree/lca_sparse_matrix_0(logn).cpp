//for balanced tree brute force is logn
//for unbalanced this is log n, brute force is n
//for unbalanced euler tour + rmq using sparse matrix is o(1)
...
int lca(int u,int v)
{
    ...
    if(u==v)
        return u;
    //Maximum lifting we can do till we have same node -> returns child of lca 
